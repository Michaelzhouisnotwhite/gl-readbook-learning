...
class TestMaterial : public OpenglWindow {
public:
    ...
    static void onFrameResizeCallBack(GLFWwindow* window, int width, int height){
        ...
        TestMaterial* self = reinterpret_cast<TestMaterial*>(glfwGetWindowUserPointer(window));
        self->width_ = width;
        self->height_ = height;
    }
    // clang-format on
    ...
    void init() override {
        ...
        cube_shader_.reset(new Shader("./media/shaders/learning.ogl/cube_material.vs",
                                      "./media/shaders/learning.ogl/cube_material.fs"));
    ...
    void display() override {
        ...
        cube_shader_->setVec3f("material.ambient", {1.0f, 0.5f, 0.31f});
        cube_shader_->setVec3f("material.diffuse", {1.0f, 0.5f, 0.31f});
        cube_shader_->setVec3f("material.specular", {0.5f, 0.5f, 0.5f});
        cube_shader_->setFloat("material.shininess", 32);
