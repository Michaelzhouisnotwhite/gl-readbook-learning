...
void main(void)
{
    ...
    static const char render_vs[] = "#version 430 core\n"
                                    "\n"
                                    "in vec4 vert;\n"
                                    "\n"
                                    "uniform mat4 mvp;\n"
...
void ComputeParticleSimulator::Display(bool auto_redraw)
{
    ...
    vmath::mat4 mvp = vmath::perspective(45.0f, aspect_ratio, 0.1f, 1000.0f) * vmath::translate(0.0f, 0.0f, -160.0f) * vmath::rotate(time * 1000.0f, vmath::vec3(0.0f, 1.0f, 0.0f));
